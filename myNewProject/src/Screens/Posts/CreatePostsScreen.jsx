...
export const CreatePostsScreen = ({ navigation }) => {
  ...
  return (
    ...
    >
      <TouchableWithoutFeedback onPress={isFocused ? keyboardToggler : null}>
        <View
          style={{
            ...styles.inner,
            ...
            <View>
              <TextInput
                style={{
                  ...styles.input,
                  borderBottomColor:
                    borderChangeColor === 'title' ? '#FF6C00' : '#E8E8E8',
                }}
            ...
            <View>
              <TextInput
                style={{
                  ...styles.input,
                  borderBottomColor:
                    borderChangeColor === 'location' ? '#FF6C00' : '#E8E8E8',
                  marginTop: 16,
                  paddingLeft: 28,
                }}
              ...
              <EvilIcons
                name="location"
                size={24}
                color={borderChangeColor === 'location' ? '#FF6C00' : '#BDBDBD'}
